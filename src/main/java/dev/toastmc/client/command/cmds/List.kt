    ...
    override fun run(args: Array<String>) {
        ...
        if (args.isEmpty()) {
            ...
            for (category in Category.values()) {
                ...
                if(ToastClient.MODULE_MANAGER.getModulesInCategory(category).isNotEmpty()){
            ...
            for (category in Category.values()) {
                if (category.name.equals(args[0], ignoreCase = true)) {
                    ...
                    for (module in ToastClient.MODULE_MANAGER.getModulesInCategory(Category.valueOf(args[0].toUpperCase()))) {
