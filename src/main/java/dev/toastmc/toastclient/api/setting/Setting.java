...
public class Setting<T> {
  ...
  public Setting(
      final String name, final Module parent, final Module.Category faxCategory, final Type type) {
    this.name = name;
  ...
  public static class Number extends Setting<Number> implements NumberSetting {
    ...
    public Number(
        final String name, final Module parent, final int value, final int min, final int max) {
      super(name, parent, parent.getCategory(), Type.NUMBER);
      this.value = value;
      this.min = min;
      this.max = max;
  ...
  public static class Boolean extends Setting<Boolean> implements BooleanSetting {
    ...
    public Boolean(final String name, final Module parent, final boolean value) {
  ...
  public static class Mode extends Setting<Mode> implements EnumSetting {
    ...
    public Mode(
        final String name, final Module parent, final String value, final List<String> modes) {
      super(name, parent, parent.getCategory(), Type.MODE);
      this.value = value;
      this.modes = modes;
    }
  ...
  public static class ColorSetting extends Setting<ColorSetting>
      implements dev.toastmc.toastclient.api.setting.types.ColorSetting {

    private boolean rainbow;
    private ToastColor value;

    public ColorSetting(
        final String name, final Module parent, boolean rainbow, final ToastColor value) {
    ...
    public ToastColor getValue() {
      if (rainbow) {
        return ToastColor.Companion.fromHSB(
            (System.currentTimeMillis() % (360 * 32)) / (360f * 32), 1, 1, value.getAlpha());
      }
      return this.value;
    }
