...
open class Module(private var name: String, private var category: Category) : IToastClient {
    ...
    protected open fun number(name: String, value: kotlin.Number, min: kotlin.Number, max: kotlin.Number, precision: Int): Number {
        return SettingManager.addSetting(Number(name, this, value.toDouble(), min.toDouble(), max.toDouble(), precision)) as Number
    }
