...
import static dev.toastmc.client.ToastClient.FILE_MANAGER;
import static dev.toastmc.client.ToastClient.clickGui;
...
public class ClickGuiSettings {
    ...
    public void loadPositions() {
        try {
            categoryPositions = gson.fromJson(new FileReader(ToastClient.FILE_MANAGER.createFile(new File(clickguiPosFile))), new TypeToken<Map<String, CategorySetting>>() {
            }.getType());
            if (categoryPositions == null && ToastClient.clickGui != null) {
    ...
    public void savePositions() {
        ToastClient.FILE_MANAGER.writeFile(new File(clickguiPosFile), gson.toJson(categoryPositions));
    }

    public void saveColors() {
        ToastClient.FILE_MANAGER.writeFile(new File(clickguiColorsFile), gson.toJson(colors));
    }
    ...
    public void loadColors() {
        try {
            colors = gson.fromJson(new FileReader(ToastClient.FILE_MANAGER.createFile(new File(clickguiColorsFile))), new TypeToken<Colors>() {
            }.getType());
            if (colors == null) {
                allDefaults();
                saveColors();
