    ...
    private fun findValidEntities() {
        for (entity in mc.world!!.entities){
            ...
            when {
                ...
                players && entity is PlayerEntity && entity.displayName != mc.player!!.displayName && !entity.isCreative && !entity.isSpectator && mc.player!!.distanceTo(entity) <= 10 && (!FriendManager.isFriend(entity.uuid) || !FriendManager.friendsModuleEnabled()) -> entities.add(entity)
