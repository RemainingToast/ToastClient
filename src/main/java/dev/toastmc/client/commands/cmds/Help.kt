...
class Help : Command("Help", "${ToastClient.cmdPrefix}help [command]", "Shows all commands", false, "help", "commands") {
    ...
    override fun run(args: Array<String>) {
        ...
        if (args.isEmpty()) {
            ...
            msg.append("\n").append(Formatting.GRAY).append(" - Aliases: ").append(Formatting.YELLOW).append(
                ToastClient.cmdPrefix).append(java.lang.String.join(Formatting.GRAY.toString() + ", " + Formatting.YELLOW + ToastClient.cmdPrefix, *cmd.aliases)).append("\n")
